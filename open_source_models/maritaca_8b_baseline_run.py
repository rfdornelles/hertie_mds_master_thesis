...
# definitions
experiment = 'experiment_llama_3.2_3B_baseline_ft_unsloth_2025-04-13_17-52-07'
folder = f'experiments/{experiment}/'
os.makedirs(folder, exist_ok=True)

# merge both
datasets = load_from_disk('../data/test').to_pandas()
...
# load model
model = '/workspace/master_thesis/master_thesis/open_source_models/ft_unsloth__Llama-3.2-3B-Instruct_v1_2025-04-13_17-52-07'#'meta-llama/Llama-3.2-3B-Instruct'
