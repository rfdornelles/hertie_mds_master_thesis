...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "2,3" # Set the visible devices
...
ckpt = "google/gemma-3-1b-it" #"unsloth/gemma-3-27b-it-GGUF" #"unsloth/gemma-3-27b-it-unsloth-bnb-4bit" #"google/gemma-3-4b-it"
