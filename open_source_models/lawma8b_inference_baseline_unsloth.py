...
# definitions
experiment = 'experiment_baseline_lawma_8b_unsloth_inference'
folder = f'../experiments/{experiment}'

os.makedirs(folder, exist_ok=True)

## Configuration
ckpt = "ricdomolm/lawma-8b" #"unsloth/Phi-4"
max_seq_length = 2048 * 9
num_train_epochs = 10
full_finetuning = False
now = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
experiment_name = f"run_unsloth_baseline_{'full' if full_finetuning else 'lora'}_{ckpt.split('/')[1]}_v1"
