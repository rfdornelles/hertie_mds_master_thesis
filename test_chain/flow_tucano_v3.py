...
########################################
llm_model_name = "nicholasKluge/TeenyTinyLlama-460m"
...
results_df.to_csv("/home/usuario/test_chain/resultados_extracao_validacao_grouped_TeenyTinyLlama.csv", index=False)
