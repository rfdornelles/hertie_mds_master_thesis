...
![Illustration of the extraction of information from a judicial decision. There are multiple tasks that depend on understanding the text and following rules](images/schema-extraction.png){#fig-schema-extraction}
